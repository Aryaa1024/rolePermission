...
<head>
    ...
    <title> Meno - Bootstrap 5 Premium Admin & Dashboard Template </title>
...
<body>
    ...
    <div class="page">
        <!-- app-header -->
        @include('templates.template1.admin.master.header')
        <!-- /app-header -->
        <!-- Start::app-sidebar -->
        @include('templates.template1.admin.master.sidebar')
        <!-- End::app-sidebar -->
        ...
        <!-- Footer Start -->
        @include('templates.template1.admin.master.footer')
        <!-- Footer End -->
